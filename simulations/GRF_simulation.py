...
if __name__=='__main__':
    ...
    parser.add_argument('-additive','--additive', help='Aditivity of signal', type=bool)
    parser.add_argument('-nuisance','--nuisance', help='Presence of nuisance main effect terms', type=bool)
